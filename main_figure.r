...
# pdf(paste(figurepath, "Coryphoideae_tree_genetree_support.pdf", sep = ""), height = (15.3*3), width = 11)
...
split.plotTree(test_tree, splits = c(0.2819,0.398,0.6081,0.845), ftype = "i", mar = c(3,1,1,1), color = pal_orthologs_t,
 fsize = 1, type = "phylogram", cex = 0.5, file = "split_plot_cory_orthologs.pdf", x_lim = c(0,23), tipcols = tipcols_orthologs, clades = dat_subfam)
