...
def tree_mover(path_in, gene,path_out ):
    ...
    echo Moving file {gene}_part.txt.treefile too the folder :{path_out}
    echo While also renaming the file to {gene}.txt.tre
    
    echo making a copy of the _part.txt.treefile in {path_out}
    cp -f {gene}_part.txt.treefile {path_out}
    
    echo renaming the {gene}_part.txt.treefile to {gene}.txt.tre
    mv -f {path_out}{gene}_part.txt.treefile {path_out}{gene}.txt.tre
...
bad_genes = ["EGU105059594","EGU105059996","HEY168","HEY363"]

genes_no_partition = ["EGU105040281","EGU105044846","EGU105045509","EGU105045514","EGU105046518","EGU105043374","EGU105054529"]
