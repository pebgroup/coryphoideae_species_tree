...
def newick_contracting_orthologs(path_in,path_out ):
	...
	for f in *_rooted.tre
	do 
		nw_ed $f 'i & (b<30)' o >> {path_out}genetrees_orthologs.tre #Moves trees used in treebuilding
