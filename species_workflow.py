...
def secapr_quality_check_raw(path_in, path_out, done,):
    ...
    options = {'cores': 1, 'memory': "10g", 'walltime': "02:00:00", 'account':"Coryphoideae"}
...
def trimmomatic(species, path_in, path_out, done):
    ...
    inputs = []
    outputs = [path_out+species+".fastq", done, path_out+species+"_1P.fastq", path_out+species+"_2P.fastq", path_out+species+"_UN.fastq"]
