...
########################################################################################################################
def renamer(path_in ,rename_file, done,remove_file):
    """"""
    inputs = []
    outputs = [done]
    ...
    # Use the names_1_data_1_rename_seqs.csv to rename the sequences in folder
    cd {path_in}

    bash /home/owrisberg/Coryphoideae/github_code/renamer_remove.sh -r {rename_file} -d {remove_file}
...
def namelist_function(path_in, path_out, done):
    """Create a namelist of all the species in the trimmomatic folder."""
    inputs = [] # The files which the job will look for before it runs
    outputs = [] # The files which will have to be created in order for the job to be "completed"
    options = {'cores': 10, 'memory': "20g", 'walltime': "100:00:00", 'account':"Coryphoideae"} #Slurm commands
...
def hybpiper(species, p1, p2, un, path_out, path_in, done, target_sequence):
    """Hybpiper assemble ."""
    ...
    conda activate hybpiper_env

    cd /scratch/$SLURM_JOBID
        
    hybpiper assemble --cpu 10 --readfiles {p1} {p2} --unpaired {un} -b {target_sequence} --prefix {species} --bwa

    cp --recursive --update {species} {out}
...
script_dir = os.path.dirname(getsourcefile(renamer)) + "/"
data_dir = os.path.normpath(os.path.join(script_dir, "../../data/")) +"/"
workflow_dir = os.path.normpath(os.path.join(script_dir, "../../work_flow/")) +"/"
...
sp = ["1001","1002","1003","1004","1005","1006","1007","1008","1009","1010","1011","1012","1013","1014","1015","1016","1017","1018","1019","1020","1021","1022","1023","1024","1025","1026","1027","1028","1029","1030","1031","1032","1033","1034","1035","1036","1037","1038","1039","1040","1041","1042","1043","1044","1045","1046","1047","1048","1049","1050","1051","1052","1053","1054","1055","1056","1057","1058","1059","1060","1061","1062","1063","1064","1065","1066","1067","1068","1069","1070","1071","1072","1073","1074","1075","1076","1077","1078","1079","1080","1099","1081","1082","1193","1194","1195","1196","1197","1222","1224","1237","1238","1239","1244","1245","1246","1247","1248","1249","1250","1251","1252","1255","1256","1257","1258","1259","1266","1267","1268","1269","1273","1274","1275","1276","1344","1345","1346","1347","1348","1349","1350","1351","1352","1353","1354","1355","1362","1363","1364","1411","1412","1413","1414","1415","1416","1417","1418","1419","1421","1430","1431","1432","1433","1434","1435","1437","1438","1439","1440","1442","1443","1444","1445","1447","1449","1459","1460","1461","1462","1463","1465","1469","1470","1475","1476","1477","1478","1488","1489","1492","2001","2002","2003","2004","2005","2006","2007","2008","2009","2010","2011","2018","2019","2028","2035","2037","2038","2039","2040","2041","2042","2043","2044","2045","2046","2047","2048","2049","2050","2055","2058","2059","2060","2061","2062","2063","2064","2065","2066","2067","2068","2069","3000","3002","3004","3006","3008","3010","3012","3014","3016","3018","3020","3022","3024","3026","3028","3030","3032","3034","3